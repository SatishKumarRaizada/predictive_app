...
class PredictiveDataTableWidget extends StatefulWidget {
  const PredictiveDataTableWidget({super.key});
  @override
  State<PredictiveDataTableWidget> createState() => _PredictiveDataTableWidgetState();
}

class _PredictiveDataTableWidgetState extends State<PredictiveDataTableWidget> {
